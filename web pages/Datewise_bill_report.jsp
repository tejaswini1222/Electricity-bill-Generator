<%-- 
    Document   : Datewise_bill_report
    Created on : Feb 29, 2024, 9:58:04 AM
    Author     : PCS
--%>
	...
	<div id="tooplate_main_wrapper">
		...
		<div id="tooplate_main">
                    ...
                    <table border="2" width="700px">
                        <thead>
                                    <tr align="center">
                                        <th colspan="7"><h3>Bill Report</h3></th>
                                        
                                    </tr>
                                </thead>
                           
                               <tr height="50px">
                                   <td align="ceter" colspan="4">Bill Date</td><td align="center" colspan="3"><input type="date" name="txtdate" value="" /></td>
                   ...
                   String dt=request.getParameter("txtdate");
                    ...
                    String str= "select * from payment where date='"+dt+"'";
