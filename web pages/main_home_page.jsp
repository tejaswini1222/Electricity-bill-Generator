	...
	<div id="tooplate_main_wrapper">
		...
		<div id="tooplate_header">
			...
			<div id="tooplate_menu">
				<ul>
                                    <li><a href="main_home_page.jsp" class="current">Home</a></li>
                                    <li><a href="Admin_login_page.jsp">Admin</a></li>
                                    <li><a href="Customer_login.jsp">Customer</a></li>
                                    <li><a href="about us.jsp">AboutUs</a></li>
                                    <li><a href="contact us.jsp">ContactUs</a></li>
