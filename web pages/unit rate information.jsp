...
<script type="text/javascript" src="js/contentslider.js">
	...
	<div id="tooplate_main_wrapper">
		...
		<div id="tooplate_header">
			<div id="site_title"><h1><a>Electricity  Bill Payment</a></h1></div>
                ...
                <table border="1"width="600px" align="center">
                    ...
                    <tbody>
                        ...
                        <tr align="center">
                            ...
                            <td width="600px"><input type="text" name="vahak_kar" value="" /></td>
                                
                        </tr>
                        <tr align="center">
                            <td width="600px" >Indhan Kar</td>
                            <td width="600px"><input type="text" name="indhan_kar" value="" /></td>
                                
                        </tr>
                        <tr align="center">
                            <td width="600px" >Vijshulk</td>
                            <td width="600px"><input type="text" name="Vij_shulk" value="" /></td>
                        ...
                        <tr align="center">
                            ...
                            <td width="600px"><input type="text" name="static_rate" value="" /></td>
                                </select></td>
                        </tr>
                        <tr align="center">
                    ...
                    tr=request.getParameter("vahak_kar");
                    fc=request.getParameter("indhan_kar");
                    ec=request.getParameter("Vij_shulk");
                    sr=request.getParameter("static_rate");
                     Statement st1=con.createStatement();
                     if(mt!=null && mt!="" && minu!=null && minu!="" && maxu!=null && maxu!="" && ur!=null && ur!="" && tr!=null && tr!="" && fc!=null && fc!="" && ec!=null && ec!="" && sr!=null && sr!="")
                    {
                        String str1="insert into rate_info(meter_type,minunit,maxunit,unit_rate,vahak_kar,indhan_kar,Vij_shulk,static_rate)values('"+mt+"',"+minu+","+maxu+","+ur+","+tr+","+fc+","+ec+","+sr+")";
                        int i=st1.executeUpdate(str1);
                        out.println("<script>alert('Store unit Rate Successfully')</script>");
                    }
